                    ...
                    <form role="form" method="POST" action={{ route('stages.affecterJury' , $stage->id) }} enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="rapporteur_id">Enseignant-rapporteur</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="president_id">Enseignant-president</label>
                                            <select name="president_id"  id="president_id" class="form-control">
                                                <option value="0">---choix enseignant ---</option>
                                                        @foreach ($enseignants as $enseignant) 
                                                        <option value="{{$enseignant->id}}" {{(old('enseignant_id', $enseignant->id) == $president?->id) ? 'selected' : ''}}> {{$enseignant->user->nom }} {{ $enseignant->user->prenom }}  </option>
                                                        @endforeach
                                            </select>
                                    </div>
                                </div>
